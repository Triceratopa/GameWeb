...
public class JwtTokenUtil {
    ...
    private final WebPlayerRepository webPlayerRepository;
    ...
    public int getLevelFromToken(String token) {
        return webPlayerRepository.findByUsername(getUsernameFromToken(token)).get().getLevel();
    }

    public Long getIdFromToken(String token) {
        return webPlayerRepository.findByUsername(getUsernameFromToken(token)).get().getId();
    }
